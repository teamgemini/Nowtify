...
from nowtifydjango2.models import Wearable, Wearable_Battery, Wearable_Usage
from nowtifydjango2.models import Sensor, Sensor_Battery, Sensor_Usage
...
def sensor(request):
    ...
    return render(request, "sensor.html", {'dataSet': sensorData})
...
def wearable(request):
    ...
    return render(request, "wearable.html", {'dataSet': wearableData})
